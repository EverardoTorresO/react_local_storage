...
const Paciente = ({paciente,key,setPaciente,eliminarPaciente}) => {
    ...
    return (
        <div className='m-3 bg-white shadow-md px-5 py-10 rounded-xl'>
            <p className='font-bold mb-3 text-gray-700 uppercase'>Nombre: {' '} <span className='font-normal normal-case'>{paciente.mascota} </span></p>
